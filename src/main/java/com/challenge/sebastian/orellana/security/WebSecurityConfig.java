...
import com.challenge.sebastian.orellana.security.jwt.AuthEntryPointJwt;
import com.challenge.sebastian.orellana.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/user/**").access("isAuthenticated()")
